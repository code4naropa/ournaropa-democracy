...
module OurnaropaDecisions
  class DecisionsControllerTest < ActionController::TestCase
    setup do
      @decision = ournaropa_decisions_decisions(:one)
    ...
    test "should create decision" do
      assert_difference('Decision.count') do
        post :create, decision: { author: @decision.author, description: @decision.description, title: @decision.title }
      end
    ...
    test "should update decision" do
      patch :update, id: @decision, decision: { author: @decision.author, description: @decision.description, title: @decision.title }
      assert_redirected_to decision_path(assigns(:decision))
    end
